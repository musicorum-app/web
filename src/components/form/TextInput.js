...
const Input = styled.input`
  ...
  border: 2px solid ${p => p.error ? "rgba(255, 0, 0, 0.45)" : "rgba(255, 255, 255, 0.35)"};
  transition: .18s;

  &:hover {
    background: ${p => p.error ? "rgba(255, 0, 0, 0.08)" : "rgba(255, 255, 255, .05)"};
    border: 2px solid ${p => p.error ? "rgba(255, 0, 0, 0.6)" : "rgba(255, 255, 255, 0.5)"};
  }

  &:focus {
    background: ${p => p.error ? "rgba(255, 0, 0, .1)" : "rgba(255, 255, 255, .09)"};
      //border: 2px solid ${darkerRed};
    border: 2px solid ${p => p.error ? "rgba(255, 0, 0, 0.8)" : "rgba(255, 255, 255, 0.65)"};
    outline: none;
  }
`
